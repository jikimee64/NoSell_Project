...
public class NaverOauth implements SocialOauth {
    ...
    @Override
    public AuthDto.NaverProfileRes userInfoNaver(TokenRes tokenRes) {
//        Map<String, Object> params = new HashMap<>();
//        System.out.println("access_token : " + tokenRes.getAccess_token());
//        params.put("access_token", tokenRes.getAccess_token());

        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.add("Authorization", "Bearer " + tokenRes.getAccess_token());

        log.info("네이버 액세스 토큰 : " + tokenRes.getAccess_token());
        try {
